...
<body>
	...
	<p>
	I plan to put some of my past personal and school projects on my <a href="projectpage.php">projects page</a> for download, as well as examples of code I've written as part of them. Feel free to play around with them, and see how their code is written. I hope it will give a good idea of what I'm able to do and my typical style of work.
	</p>
	<p>
	...
	<hr>
	<h4>So..what's up with the random tab about the weather?</h4>
	<p>
	Yes, yes, I'm sure you're also asking what's up with all the weather mentions on this site? Why do I have a section about weather on a portfolio primarily about my desire to work with technology? 
	</p> 
	<p>
	...
	<p>However, if I go on much more about it here, it'll take up half the page, and I already have a specific place dedicated to it on this site, so if you're intruiged by my interest in weather, or want to see some quite frankly awesome pictures, click on over to "<a href="weatherpage.php">And now, the weather!</a>".	
	</p>
	<hr> 
