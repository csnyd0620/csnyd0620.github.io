...
<body>
    ...
    <section class="main_content">
		...
		<hr>
	    <h4>Enough about work personality....what about me as a person <i>outside</i> of work?</h4>
	    <p> 
	    ...
	    <img src = "images/cosplay.png" alt = "A picture of Chris in a Jedi cosplay. Chris's face is blurred. The cosplay has gold and blue thick shoulder straps (tabbards), a blue and gold belt, and white and tan tunic. Chris is wearing a headpiece that has two tail-like pieces hanging down past their shoulders that are designed as lekku from Twilek's from Star Wars. Chris is holding a black lightsaber that is set to yellow, almost gold, as the color." id = "cosplayPic"/> 
		<p id ="picture_info">
